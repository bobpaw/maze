/*
  ...
  gengetopt --file-name=cmdline-maze
...
const char *gengetopt_args_info_detailed_help[] = {
  ...
  "  If given width is larger than terminal, it is sized down to maximum value.",
  "  -H, --height=INT     Maze Height",
  "  If given height is larger than terminal, it is sized down to maximum value.",
    0
};
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (args_info->width_given && ! args_info->height_given)
    {
      fprintf (stderr, "%s: '--width' ('-W') option depends on option 'height'%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  if (args_info->height_given && ! args_info->width_given)
    {
      fprintf (stderr, "%s: '--height' ('-H') option depends on option 'width'%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVW:H:", long_options, &option_index);
