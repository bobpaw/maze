/*
  ...
  gengetopt --file-name=cmdline-put
...
const char *gengetopt_args_info_detailed_help[] = {
  ...
  "  -g, --guess          Interactive solution guessing",
  "\nMaze Types:",
  "  -w, --walls          Print a wall based maze",
  "  -c, --cells          Print a cell based maze",
  "  -b, --both           Print both a cell based and wall based maze",
  "  Print wall based first and then cell based.",
  "\nDimensions:",
  "  -m, --maximize       Maximie dimensions",
  "  -W, --width=INT      Maze Width",
  "  Width of wall based maze",
  "  -H, --height=INT     Maze Height",
  "  Height of wall based maze",
    0
};
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->guess_given = 0 ;
  args_info->walls_given = 0 ;
  args_info->cells_given = 0 ;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->guess_help = gengetopt_args_info_detailed_help[3] ;
  args_info->walls_help = gengetopt_args_info_detailed_help[5] ;
  args_info->cells_help = gengetopt_args_info_detailed_help[6] ;
  args_info->both_help = gengetopt_args_info_detailed_help[7] ;
  args_info->maximize_help = gengetopt_args_info_detailed_help[10] ;
  args_info->width_help = gengetopt_args_info_detailed_help[11] ;
  args_info->height_help = gengetopt_args_info_detailed_help[13] ;
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->guess_given)
    write_into_file(outfile, "guess", 0, 0 );
  if (args_info->walls_given)
    write_into_file(outfile, "walls", 0, 0 );
  if (args_info->cells_given)
    write_into_file(outfile, "cells", 0, 0 );
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVgwcbmW:H:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'g':	/* Interactive solution guessing.  */
        
        
          if (update_arg( 0 , 
               0 , &(args_info->guess_given),
              &(local_args_info.guess_given), optarg, 0, 0, ARG_NO,
          ...
          break;
        case 'w':	/* Print a wall based maze.  */
        
        
          if (update_arg( 0 , 
               0 , &(args_info->walls_given),
              &(local_args_info.walls_given), optarg, 0, 0, ARG_NO,
              check_ambiguity, override, 0, 0,
              "walls", 'w',
              additional_error))
            goto failure;
          ...
          break;
        case 'c':	/* Print a cell based maze.  */
        
        
          if (update_arg( 0 , 
               0 , &(args_info->cells_given),
              &(local_args_info.cells_given), optarg, 0, 0, ARG_NO,
              check_ambiguity, override, 0, 0,
              "cells", 'c',
              additional_error))
            goto failure;
          ...
          break;
        case 'b':	/* Print both a cell based and wall based maze.  */
        
        
          if (update_arg( 0 , 
               0 , &(args_info->both_given),
              &(local_args_info.both_given), optarg, 0, 0, ARG_NO,
              check_ambiguity, override, 0, 0,
              "both", 'b',
              additional_error))
            goto failure;
